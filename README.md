...
- `./runSMP.sh`: Execution script containing concrete parameter settings and execution modes (e.g., *`Single-stage SMP-Attack`* or *`Multi-stage SMP-Attack`*). Edit this script to reproduce experiments or tune parameters.
