...
model_names=['vgg_16','inception_v3','inception_v4','inception_resnet_v2','resnet_v1_50','resnet_v1_152',
             'adv_inception_v3','adv_inception_resnet_v2',
             'ens3_adv_inception_v3','ens_adv_inception_resnet_v2','ens4_adv_inception_v3']
...
def main(ori_path='./dataset/images/',adv_path='./adv/SMP',output_file='./log.csv'):
    ori_accuracys=[]
    adv_accuracys=[]
    adv_successrates=[]
    adv_successrates2=[]
...
if __name__=='__main__':
    ...
    parser.add_argument('--adv_path',default='./adv/SMP')
