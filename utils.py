...
from nets import inception_v3, inception_v4, inception_resnet_v2, resnet_v2, resnet_v1, vgg, nets_factory,mobilenet_v1
...
checkpoint_paths = {
    ...
    'resnet_v2_101': base_path+'/resnet_v2_101/resnet_v2_101.ckpt',
    ...
    'mobilenet_v1':base_path+'/mobilenet_v1/mobilenet_v1_1.0_224.ckpt',
  }
